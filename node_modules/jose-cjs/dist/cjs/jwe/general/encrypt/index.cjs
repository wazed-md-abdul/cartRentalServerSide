...
var GeneralEncrypt = class {
  ...
  async encrypt() {
    ...
    for (let i = 0; i < __privateGet(this, _recipients).length; i++) {
      ...
      if (joseHeader.zip !== void 0 && !((_a = __privateGet(this, _protectedHeader2)) == null ? void 0 : _a.zip)) {
        throw new JWEInvalid('JWE "zip" (Compression Algorithm) Header Parameter MUST be in a protected header.');
      }
    }
    ...
    for (let i = 0; i < __privateGet(this, _recipients).length; i++) {
      ...
      const alg = ((_b = recipient.unprotectedHeader) == null ? void 0 : _b.alg) || ((_c = __privateGet(this, _protectedHeader2)) == null ? void 0 : _c.alg) || ((_d = __privateGet(this, _unprotectedHeader2)) == null ? void 0 : _d.alg);
