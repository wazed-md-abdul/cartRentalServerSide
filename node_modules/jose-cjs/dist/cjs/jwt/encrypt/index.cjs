...
var FlattenedEncrypt = class {
  ...
  async encrypt(key, options) {
    ...
    if (joseHeader.zip !== void 0 && !((_a = __privateGet(this, _protectedHeader)) == null ? void 0 : _a.zip)) {
...
// dist/webapi/jwt/encrypt.js
var _cek2, _iv2, _keyManagementParameters2, _protectedHeader2, _replicateIssuerAsHeader, _replicateSubjectAsHeader, _replicateAudienceAsHeader, _jwt;
var EncryptJWT = class {
  ...
  async encrypt(key, options) {
    const enc = new CompactEncrypt(__privateGet(this, _jwt).data());
    if (__privateGet(this, _protectedHeader2) && (__privateGet(this, _replicateIssuerAsHeader) || __privateGet(this, _replicateSubjectAsHeader) || __privateGet(this, _replicateAudienceAsHeader))) {
      __privateSet(this, _protectedHeader2, {
        ...__privateGet(this, _protectedHeader2),
        iss: __privateGet(this, _replicateIssuerAsHeader) ? __privateGet(this, _jwt).iss : void 0,
        sub: __privateGet(this, _replicateSubjectAsHeader) ? __privateGet(this, _jwt).sub : void 0,
        aud: __privateGet(this, _replicateAudienceAsHeader) ? __privateGet(this, _jwt).aud : void 0
      });
    }
    enc.setProtectedHeader(__privateGet(this, _protectedHeader2));
