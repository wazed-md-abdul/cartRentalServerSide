...
var _payload, _protectedHeader, _unprotectedHeader;
var FlattenedSign = class {
  ...
  async sign(key, options) {
    ...
    let payloadB;
    if (b64) {
      payloadS = encode2(__privateGet(this, _payload));
      payloadB = encode(payloadS);
    } else {
      payloadB = __privateGet(this, _payload);
      payloadS = "";
    }
...
var JWTClaimsBuilder = class {
  constructor(payload) {
    ...
    __privateSet(this, _payload2, structuredClone(payload));
  }
  data() {
    return encoder.encode(JSON.stringify(__privateGet(this, _payload2)));
  }
  get iss() {
    return __privateGet(this, _payload2).iss;
  }
  set iss(value) {
    __privateGet(this, _payload2).iss = value;
  }
  get sub() {
    return __privateGet(this, _payload2).sub;
  }
  set sub(value) {
    __privateGet(this, _payload2).sub = value;
  }
  get aud() {
    return __privateGet(this, _payload2).aud;
  }
  set aud(value) {
    __privateGet(this, _payload2).aud = value;
  }
  set jti(value) {
    __privateGet(this, _payload2).jti = value;
  }
  set nbf(value) {
    if (typeof value === "number") {
      __privateGet(this, _payload2).nbf = validateInput("setNotBefore", value);
    } else if (value instanceof Date) {
      __privateGet(this, _payload2).nbf = validateInput("setNotBefore", epoch(value));
    } else {
      __privateGet(this, _payload2).nbf = epoch(/* @__PURE__ */ new Date()) + secs(value);
    }
  }
  set exp(value) {
    if (typeof value === "number") {
      __privateGet(this, _payload2).exp = validateInput("setExpirationTime", value);
    } else if (value instanceof Date) {
      __privateGet(this, _payload2).exp = validateInput("setExpirationTime", epoch(value));
    } else {
      __privateGet(this, _payload2).exp = epoch(/* @__PURE__ */ new Date()) + secs(value);
    }
  }
  set iat(value) {
    if (value === void 0) {
      __privateGet(this, _payload2).iat = epoch(/* @__PURE__ */ new Date());
    } else if (value instanceof Date) {
      __privateGet(this, _payload2).iat = validateInput("setIssuedAt", epoch(value));
    } else if (typeof value === "string") {
      __privateGet(this, _payload2).iat = validateInput("setIssuedAt", epoch(/* @__PURE__ */ new Date()) + secs(value));
    } else {
      __privateGet(this, _payload2).iat = validateInput("setIssuedAt", value);
    }
  }
};
