...
var IndividualSignature = class {
  ...
  addSignature(...args) {
    return __privateGet(this, _parent).addSignature(...args);
  }
  sign(...args) {
    return __privateGet(this, _parent).sign(...args);
  }
  done() {
...
var GeneralSign = class {
  ...
  async sign() {
    ...
    for (let i = 0; i < __privateGet(this, _signatures).length; i++) {
      ...
      const flattened = new FlattenedSign(__privateGet(this, _payload2));
