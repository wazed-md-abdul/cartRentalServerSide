...
async function flattenedDecrypt(jwe, key, options) {
  ...
  if (joseHeader.zip !== void 0 && !(parsedProt == null ? void 0 : parsedProt.zip)) {
  ...
  if (joseHeader.zip === "DEF") {
    const maxDecompressedLength = (options == null ? void 0 : options.maxDecompressedLength) ?? 25e4;
...
var FlattenedEncrypt = class {
  ...
  setKeyManagementParameters(parameters) {
    assertNotSet(__privateGet(this, _keyManagementParameters), "setKeyManagementParameters");
  ...
  setSharedUnprotectedHeader(sharedUnprotectedHeader) {
    assertNotSet(__privateGet(this, _sharedUnprotectedHeader), "setSharedUnprotectedHeader");
  ...
  setContentEncryptionKey(cek) {
    assertNotSet(__privateGet(this, _cek), "setContentEncryptionKey");
    __privateSet(this, _cek, cek);
    return this;
  }
  setInitializationVector(iv) {
    assertNotSet(__privateGet(this, _iv), "setInitializationVector");
  ...
  async encrypt(key, options) {
    ...
    if (joseHeader.zip !== void 0 && !((_a2 = __privateGet(this, _protectedHeader)) == null ? void 0 : _a2.zip)) {
      throw new JWEInvalid('JWE "zip" (Compression Algorithm) Header Parameter MUST be in a protected header.');
    }
    const { alg, enc } = joseHeader;
    if (typeof alg !== "string" || !alg) {
    ...
    let plaintext = __privateGet(this, _plaintext);
    if (joseHeader.zip === "DEF") {
      plaintext = await compress(plaintext).catch((cause) => {
        throw new JWEInvalid("Failed to compress plaintext", { cause });
      });
    }
    const { ciphertext, tag: tag2, iv } = await encrypt(enc, plaintext, cek, __privateGet(this, _iv), additionalData);
    const jwe = {
...
var GeneralEncrypt = class {
  ...
  setProtectedHeader(protectedHeader) {
    assertNotSet(__privateGet(this, _protectedHeader2), "setProtectedHeader");
    __privateSet(this, _protectedHeader2, protectedHeader);
    return this;
  }
  setSharedUnprotectedHeader(sharedUnprotectedHeader) {
    assertNotSet(__privateGet(this, _unprotectedHeader2), "setSharedUnprotectedHeader");
  ...
  async encrypt() {
    ...
    for (let i = 0; i < __privateGet(this, _recipients).length; i++) {
      ...
      if (joseHeader.zip !== void 0 && !((_a2 = __privateGet(this, _protectedHeader2)) == null ? void 0 : _a2.zip)) {
        throw new JWEInvalid('JWE "zip" (Compression Algorithm) Header Parameter MUST be in a protected header.');
      }
    }
    ...
    for (let i = 0; i < __privateGet(this, _recipients).length; i++) {
      ...
      const alg = ((_b2 = recipient.unprotectedHeader) == null ? void 0 : _b2.alg) || ((_c = __privateGet(this, _protectedHeader2)) == null ? void 0 : _c.alg) || ((_d = __privateGet(this, _unprotectedHeader2)) == null ? void 0 : _d.alg);
...
var FlattenedSign = class {
  ...
  setProtectedHeader(protectedHeader) {
    assertNotSet(__privateGet(this, _protectedHeader3), "setProtectedHeader");
    __privateSet(this, _protectedHeader3, protectedHeader);
    return this;
  }
  setUnprotectedHeader(unprotectedHeader) {
    assertNotSet(__privateGet(this, _unprotectedHeader3), "setUnprotectedHeader");
...
var SignJWT = class {
  ...
  async sign(key, options) {
    ...
    if (Array.isArray((_a2 = __privateGet(this, _protectedHeader4)) == null ? void 0 : _a2.crit) && __privateGet(this, _protectedHeader4).crit.includes("b64") && __privateGet(this, _protectedHeader4).b64 === false) {
      throw new JWTInvalid("JWTs MUST NOT use unencoded payload");
    }
...
var EncryptJWT = class {
  ...
  setProtectedHeader(protectedHeader) {
    assertNotSet(__privateGet(this, _protectedHeader5), "setProtectedHeader");
    __privateSet(this, _protectedHeader5, protectedHeader);
    return this;
  }
  setKeyManagementParameters(parameters) {
    assertNotSet(__privateGet(this, _keyManagementParameters2), "setKeyManagementParameters");
    __privateSet(this, _keyManagementParameters2, parameters);
    return this;
  }
  setContentEncryptionKey(cek) {
    assertNotSet(__privateGet(this, _cek2), "setContentEncryptionKey");
    __privateSet(this, _cek2, cek);
    return this;
  }
  setInitializationVector(iv) {
    assertNotSet(__privateGet(this, _iv2), "setInitializationVector");
